<template>
  <el-drawer ref="drawerRef" v-model="dialog.value1" title="To register a new hotel!" :before-close="handleClose_drawer"
    ...
    <div>
      ...
      <div style="position: relative; left: 30%">
        ...
        <el-button type="primary" @click="submitNewHotel">{{ 'Submit' }}</el-button>
      </div>
    </div>
  </el-drawer>
</template>
...
const submitNewHotel = () => {
  if (form.address == '' || form.name == '' || form.province == '' || form.city == '' || form.region == '' || form.latitude == '' || form.longitude == '' || form.tel == '') {
    ElNotification({
      title: 'Fail',
