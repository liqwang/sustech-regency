  ...
  <el-card class="box-card" style="border-radius: 15px">
    ...
    <el-row :gutter="20">
      <div style="height: 75vh">
        <div v-show="v1" style="width: 100%; height: 100%" class="img">
        ...
        <div v-show="v2" style="width: 100%; height: 100%" class="img">
        ...
        <div v-show="v3" style="width: 100%; height: 100%" class="img">
